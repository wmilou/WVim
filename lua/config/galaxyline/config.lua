  ...
  ViMode = {
    provider = function()
      ...
      local mode_color = {
        ...
        i = nord_colors.green,
        v = nord_colors.blue, [""] = nord_colors.blue, V = nord_colors.blue,
        c = nord_colors.red,
