...
install_neovim_latest_version(){
    ...
    printf "\n${RED}git not found in path. Please install it to continue!${NC}\n"
    exit
    fi
...
install_wvim_configs(){
    printf "${GREEN}Instaling WVIM config ... ${NC} \n"
    mv ~/.config/nvim ~/.config/nvim_old_$(date +%F_%R)
    git clone https://github.com/wmilou/WVim.git ~/.config/nvim
